...
module.exports = async (mcc, psp, charges_type, payment_mode) => {
      ...
      let query = "select * from " + config.table_prefix + "charges_transaction_setup where psp =" + psp + " AND charges_type =" + "'" + charges_type + "'" + " AND mcc IN" + "(" + mcc + ")" +" AND payment_mode IN " + "(" + "'" + payment_mode + "'" + ")";
