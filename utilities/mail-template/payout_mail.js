                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="middle" style="border-collapse:collapse;padding-bottom:16px;border-bottom:1px solid #eaeaed">
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" valign="top" style="border-collapse:collapse;"><b>Payout On The Way</b><br><br><span style="border-collapse:collapse;width:100%;display:block; font-weight: bolder;color: #056e4e; ">Congratulations `+data.name+`! </span>
                                                                                        <span style="border-collapse:collapse;font-size:16px;font-weight:500;width:100%;display:block"></span>
                                                                                        <br>Kindly note that your payout scheduled on `+data.date+` is on the way to your bank account for Tila.<br><br>
                                                                                        We expect your funds to arrive within 2 business days. Please click below to find more details on your payout.
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="middle" style="border-collapse:collapse;padding:20px 8px 10px;font-size:12px">
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" align="middle" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>; padding: 10px;"><a href=""><a  href="`+data.url+`"style="background-color: #056e4e;padding: 10px;border-radius: 10px;color: white;width: 80% !important;font-size: 20px;border: 0;">PAYOUTS DETAILS</a></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="middle" style="border-collapse:collapse;padding:8px 0px;font-size:12px">
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>; "><span>Contact <a href="https://telr.com/contact-us/" style="color: #056e4e;">Telr Support</a> if you need any support.</span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
