                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="middle" style="border-collapse:collapse;padding-bottom:16px;border-bottom:1px solid #eaeaed">
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>"><span style="border-collapse:collapse;width:100%;display:block; font-weight: bolder;">Password Expiry </span><span style="border-collapse:collapse;font-size:16px;font-weight:500;width:100%;display:block"></span></td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" align="left" valign="top" style="border-collapse:collapse;">Dear `+data.name+`,
                                                                                        <br><br>The password associated to `+data.email+` account  is about to be expired on `+data.expiry_date+`. <br>Please reset the password, by simply clicking on the button below
                                                                                        : </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="middle" style="border-collapse:collapse;padding:5px 8px 10px;font-size:12px">
                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" align="middle" valign="top" style="border-collapse:collapse;<b>TELR0900091</b>; padding: 10px;"><a href="`+data.url+`" target="_blank"><button style="background-color: #056e4e;padding: 10px;border-radius: 10px;color: white;width: 80% !important;font-size: 20px;border: 0;">Reset Password</button></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
