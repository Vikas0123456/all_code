                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" align="left" valign="top" style="border-collapse:collapse;">Dear `+data.name+`,
                                                                                        <br><br>The password associated to `+data.email+` account  is about to be expired on tomorrow. <br>Please reset the password, by simply clicking on the button below
                                                                                        : </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
